...
const Services = () => {
  ...
  return (
    <div className="services">
      <h1>Our Herbal Services</h1>
      <p className="intro-text">
        Explore the therapeutic world of medicinal plants. Discover how these ancient remedies can
        enhance your health and well-being with insights into their uses and benefits.
      </p>
      ...
      <div className="card-grid">
        {plantData.map((plant, index) => (
          <div className="card" key={index}>
            ...
            <h3>{plant.name}</h3>
            <p><strong>Benefits:</strong> {plant.medicinalValue}</p>
      ...
      <div className="herbal-info">
        <h2>About Herbal Plants</h2>
        <p>
          Herbal plants have been used for centuries in traditional medicine systems to promote
          health and treat various ailments. Each plant carries unique properties that contribute
          to physical and mental well-being. Our medicinal plant database provides information on
          scientific names, uses, and more. However, consult professionals before use—especially
